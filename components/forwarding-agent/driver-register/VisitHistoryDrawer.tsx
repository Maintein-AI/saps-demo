...
import { X, Clock, Shield, Ban, AlertTriangle } from "lucide-react";
...
const visits: Visit[] = [
  { visitDate: "01 Jun 2026", vehicle: "KHI-4582", awb: "214-45678901", do: "DO-90871", entryTime: "13:45", exitTime: "15:20", gateStatus: "Approved", remarks: "Cold chain cargo, no issues" },
  { visitDate: "28 May 2026", vehicle: "KHI-4582", awb: "157-90811223", do: "DO-90872", entryTime: "10:15", exitTime: "11:50", gateStatus: "Approved", remarks: "Standard pickup" },
  { visitDate: "22 May 2026", vehicle: "KHI-9921", awb: "074-88219033", do: "DO-90873", entryTime: "09:30", exitTime: "11:10", gateStatus: "Approved", remarks: "DGR inspection passed" },
  { visitDate: "15 May 2026", vehicle: "KHI-4582", awb: "117-55443321", do: "DO-90874", entryTime: "14:00", exitTime: "16:30", gateStatus: "Delayed", remarks: "Customs hold extended" },
  { visitDate: "08 May 2026", vehicle: "BJU-7721", awb: "117-98765432", do: "DO-90875", entryTime: "08:45", exitTime: "10:20", gateStatus: "Approved", remarks: "Quick turnaround" },
  { visitDate: "01 May 2026", vehicle: "KHI-4582", awb: "214-99887766", do: "DO-90877", entryTime: "11:30", exitTime: "13:00", gateStatus: "Approved", remarks: "VIP cargo handled" },
  { visitDate: "24 Apr 2026", vehicle: "KHI-9934", awb: "117-44556677", do: "DO-90878", entryTime: "16:00", exitTime: "17:45", gateStatus: "Approved", remarks: "Routine pickup" },
  { visitDate: "17 Apr 2026", vehicle: "KHI-4582", awb: "074-55667788", do: "DO-90879", entryTime: "07:30", exitTime: "09:00", gateStatus: "Rejected", remarks: "Authority letter expired" },
];
...
export default function VisitHistoryDrawer({ isOpen, onClose, driver }: VisitHistoryDrawerProps) {
  useEffect(() => {
    if (isOpen) {
      ...
      >
        <div className="flex items-center justify-between px-5 h-[64px] border-b border-[#E2E8F0] flex-shrink-0">
          <div className="flex items-center gap-2">
            <h2 className="text-[16px] font-bold text-[#0F172A]">Driver Visit History</h2>
            <ScopeBadge type="exc" />
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-5 py-3 border-b border-[#E2E8F0] bg-[#F8FAFC]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#EBF0F7] flex items-center justify-center">
              <AlertTriangle size={18} className="text-[#1B4F8B]" />
            </div>
            <div>
              <p className="text-[14px] font-bold text-[#0F172A]">{driver?.name || "Select a driver"}</p>
              <p className="text-[12px] text-[#64748B] font-mono">{driver?.cnic || ""}</p>
            </div>
          </div>
        </div>
                ...
                {visits.map((visit, i) => {
                  ...
                  return (
                    <tr key={i} className="border-b border-[#F1F5F9] hover:bg-[#F8FAFC] transition-colors">
                      ...
                      <td className="py-3 px-3 text-[12px] font-mono text-[#0F172A]">{visit.vehicle}</td>
