      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-[300px]">
          ...
          <input
            type="text"
            value={filters.gd}
            onChange={(e) => updateFilter("gd", e.target.value)}
            placeholder="GD #"
            className="w-full h-10 pl-9 pr-3 rounded-xl border border-[#E2E8F0] text-[13px] text-[#0F172A] outline-none focus:border-[#1B4F8B] transition-colors"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 pt-4 border-t border-[#E2E8F0]">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Date Range (e.g. 28 May - 01 Jun)"
              className="w-full h-10 pl-9 pr-3 rounded-xl border border-[#E2E8F0] text-[13px] text-[#0F172A] outline-none focus:border-[#1B4F8B] transition-colors"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              value={filters.chaUser}
              onChange={(e) => updateFilter("chaUser", e.target.value)}
              placeholder="CHA User"
              className="w-full h-10 pl-9 pr-3 rounded-xl border border-[#E2E8F0] text-[13px] text-[#0F172A] outline-none focus:border-[#1B4F8B] transition-colors"
            />
          </div>
        </div>
