...
export default function KPIStrip() {
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      <KPI title="Total Shipments" value="42" subtitle="All time" trend="up" trendValue="+5" />
      <KPI title="Arrived" value="14" subtitle="Awaiting customs" trend="up" trendValue="+3" />
      <KPI title="Customs Pending" value="8" subtitle="3 Red channel" trend="down" trendValue="-2" />
      <KPI title="Charges Due" value="6" subtitle="PKR 1.86M" trend="up" trendValue="+2" />
      <KPI title="DO Ready" value="11" subtitle="Ready for pickup" trend="down" trendValue="-1" />
      <KPI title="Delivered" value="28" subtitle="This month" trend="up" trendValue="+4" />
    </div>
  );
}