...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { label: "Charges calculator (legacy screen)", href: "/cmts-absorption/charges-calculator" },
    ],
  ...
  },
  {
    ...
    screens: [
      ...
      { label: "Godown rent history (legacy screen)", href: "/cmts-absorption/godown-rent-history" },
    ],
  ...
  // ---- Messaging spine ----
  {
    ...
    gap: "Covered: all 13 Cargo-IMP types with per-flight pre-arrival completeness and failure surfacing, alongside the existing ULD builder.",
  },
  {
    code: "M08",
...
export const FLOWS: FlowDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: "—", label: "G.Rent voucher issued", href: "/billing/godown-rent", module: "M11" },
    ],
  },
  {
    id: "FC-08",
